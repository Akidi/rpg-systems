	...
	<div class="current-status">
		<div class="rank-progress">
			<div class="progress-bar">
				<div class="progress-fill" style="width: {getProgressPercentage(currentStep)}%"></div>
			</div>
					...
					<div class="effect-header">
						...
						<span class="effect-value">
							...
							{#if increment !== 0}
								<span
									class="increment"
									class:positive={isIncreasePositive(increment)}
									class:negative={!isIncreasePositive(increment)}
								>

...
<style>
  ...
  .rank-complete {
    background: linear-gradient(90deg, 
      ...
      rgba(var(--color-success), 0.05) 100%) !important;
  ...
  .rank-complete:hover {
    background: linear-gradient(90deg, 
      ...
      rgba(var(--color-success), 0.1) 100%) !important;
  }
  ...
  .new-binary {
    background: linear-gradient(90deg, 
      ...
      rgba(var(--color-warning), 0.05) 100%) !important;
  ...
  .new-binary:hover {
    background: linear-gradient(90deg, 
      ...
      rgba(var(--color-warning), 0.1) 100%) !important;
  }

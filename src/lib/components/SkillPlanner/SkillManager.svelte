					...
					<div class="skill-card">
						<div class="skill-card-header">
							<h5
								...
								class:combat={skill.isCombatSkill}
								class:utility={!skill.isCombatSkill}
							>
								{skill.name}
	...
	>
		<div class="modal">
			<div class="modal-header">
				...
				<button onclick={() => (showExport = false)} class="modal-close" aria-label="Close modal"
					>×</button
				>
			</div>
			<div class="modal-content">
				<p>Copy this data to share or backup your skills:</p>
				<textarea readonly bind:value={exportData} rows="15" aria-label="Exported skill data"
				></textarea>
	...
	>
		<div class="modal">
			<div class="modal-header">
				...
				<button onclick={() => (showImport = false)} class="modal-close" aria-label="Close modal"
					>×</button
				>
			</div>
			<div class="modal-content">
				...
				></textarea>
				<div class="modal-actions">
					<button onclick={importSkills} disabled={!importData.trim()} class="btn-import"

...
<div class="card">
	...
	<div class="stat-row">
		<span>AP:</span>
		<span
			class="stat-value {character.currentAP < costs.totalAPCost
				? 'stat-insufficient'
				: 'stat-sufficient'}"
		>
	...
	<div class="stat-row">
		<span>MP:</span>
		<span
			class="stat-value {character.currentMP < costs.totalMPCost ? 'stat-insufficient' : 'stat-mp'}"
		>
	...
	<div class="button-group">
		<button onclick={resetCharacter} class="btn btn-secondary"> Reset Character </button>
		<button
			onclick={nextTurn}

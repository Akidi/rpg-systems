...
<div class="card">
	...
	<div class="costs-grid">
		...
		<div class="cost-item">
			<div class="cost-number enhanced">
				{Math.ceil(baseSpell.mpCost * Math.pow(1.25, enhancements.length))}
			</div>
		...
		<div class="cost-item">
			...
			{#if enhancements.length > 0}
				<div class="cost-breakdown">
					({apRecoverySettings.recoveryPercent}% ± 15% of {costs.enhancementAPCost} + remaining)
				</div>
			{:else}
	...
	<div class="cast-section">
		<button onclick={castSpell} disabled={!canCast} class="btn btn-danger">

...
export function copperToBreakdown(totalCopper: number, rates: CurrencyConversion): CurrencyBreakdown {
	let remaining = totalCopper;
	
	const platinum = Math.floor(remaining / (rates.goldToPlatinum * rates.silverToGold * rates.copperToSilver));

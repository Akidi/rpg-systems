...
export const MATH_EXAMPLES: MathExample[] = [
	...
	},
	{
		...
		explanation:
			'First 10 STR gives big benefits, next 50 STR gives smaller gains. Prevents overpowered builds.',
	...
	},
	{
		...
		formula: 'sqrt(STR) * 10',
		explanation:
			'Middle ground between linear and logarithmic. Common in RPGs for damage reduction.',
	...
	},
	{
		...
		explanation:
			'Each level gives proportionally more than the last. Creates power spikes at high levels.',
	...
	},
	{
		...
		explanation:
			'Full value up to 50 STR, then half value after. Rewards specialization but limits extremes.',
	...
	},
	{
		...
		usage:
			'Damage multipliers, speed bonuses, or any enhancement that should scale with base values.'
	},
	{
		...
		explanation:
			'Creates natural 0-100% range with smooth transitions. Never quite reaches extremes.',
	...
	},
	{
		...
		explanation:
			'Combines multiple stats with different scaling, plus a hard cap to prevent 100% rates.',
		usage:
			'Complex derived stats like critical hit chance that should benefit from multiple attributes.'
	},
	{
		...
		explanation:
			'Fast growth early game, slower progression in late game. Creates distinct power phases.',
	...
	},
	{
		...
		formula:
			'level <= 10 ? level * 50 : level <= 30 ? 500 + (level - 10) * 25 : 1000 + (level - 30) * 10',
		explanation:
			'Three distinct phases with different growth rates. Allows fine-tuned progression curves.',
		usage:
			'Complex progression systems, multi-tier content, or games with distinct difficulty phases.'
	},
	{
		name: 'Synergy Bonus',
		...
		explanation:
			'Base value from two stats, multiplied by wisdom bonus. Encourages balanced builds.',
	...
	},
	{
		...
		usage:
			'Elite abilities, mastery bonuses, or advanced techniques that require stat prerequisites.'
	},
	{
		...
		explanation:
			'Combines three factors with different weights. Strength matters most, level least.',
	...
	},
	{
		...
		explanation:
			'Gets closer to 100 as STR increases but never quite reaches it. Natural soft cap.',
		usage:
			'Damage reduction percentages, success rates, or any stat that should have a practical maximum.'
	},
	{
		...
		explanation:
			'Base regen from two stats, boosted by level. Both immediate and long-term scaling.',
	...
	},
	{
		...
		explanation:
			'Diminishing returns formula capped at 95%. High effectiveness but never guaranteed.',
